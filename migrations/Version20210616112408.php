...
final class Version20210616112408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rent (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, deposit_id INT DEFAULT NULL, status_id INT NOT NULL, date_in DATETIME NOT NULL, date_out DATETIME NOT NULL, date_return DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_2784DCCA76ED395 (user_id), INDEX IDX_2784DCC9815E4B1 (deposit_id), INDEX IDX_2784DCC6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
