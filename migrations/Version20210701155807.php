 ...
 */
final class Version20210701155807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE accessory (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, name VARCHAR(100) NOT NULL, identifier VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, characteristic LONGTEXT DEFAULT NULL, argument_one VARCHAR(255) DEFAULT NULL, argument_two VARCHAR(255) DEFAULT NULL, argument_three VARCHAR(255) DEFAULT NULL, price_per_day DOUBLE PRECISION NOT NULL, price_service DOUBLE PRECISION NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A1B1251C5E237E06 (name), INDEX IDX_A1B1251C4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE basket (id INT AUTO_INCREMENT NOT NULL, rent_id INT DEFAULT NULL, user_id INT DEFAULT NULL, is_open TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_2246507BE5FD6250 (rent_id), INDEX IDX_2246507BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, marque_id INT NOT NULL, name VARCHAR(100) NOT NULL, identifier VARCHAR(100) DEFAULT NULL, description LONGTEXT DEFAULT NULL, storage LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, target INT DEFAULT NULL, characteristic LONGTEXT DEFAULT NULL, argument_one VARCHAR(255) DEFAULT NULL, argument_two VARCHAR(255) DEFAULT NULL, argument_three VARCHAR(255) DEFAULT NULL, price_per_day DOUBLE PRECISION NOT NULL, price_service DOUBLE PRECISION NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D34A04AD5E237E06 (name), INDEX IDX_D34A04AD4827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, user_id INT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, mark DOUBLE PRECISION DEFAULT NULL, is_validated TINYINT(1) NOT NULL, INDEX IDX_D88926224584665A (product_id), INDEX IDX_D8892622A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rent (id INT AUTO_INCREMENT NOT NULL, deposit_id INT DEFAULT NULL, status_id INT DEFAULT NULL, date_in DATETIME NOT NULL, date_out DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, date_return DATETIME DEFAULT NULL, INDEX IDX_2784DCC9815E4B1 (deposit_id), INDEX IDX_2784DCC6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, product_id INT DEFAULT NULL, accessory_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_available TINYINT(1) NOT NULL, INDEX IDX_4B3656608BAC62AF (city_id), INDEX IDX_4B3656604584665A (product_id), INDEX IDX_4B36566027E8CC78 (accessory_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
